...
import com.sd.laborator.interfaces.AgentService
...
class AgendaController {
    @Autowired
    private lateinit var agendaService: AgentService

    @RequestMapping(value = ["/form"], method = [RequestMethod.GET])
    fun getFormular(): ResponseEntity<String> {
        var string = ""

        File("D:\\an3_sem2\\sd\\lab4-restful\\src\\main\\resources\\static\\formular.html")
            .readLines()
            .forEach { string += it }
